	...
	<div class="field">
		<div class="control">
			...
			<input
				id="type"
				type="text"
				class="input is-rounded {{ $errors->has('paypal_address') ? ' is-danger' : '' }}"
				name="paypal_address"
				value="{{ $user->paypal_address }}"
				required
			/>
...
<form action="{{ url('admin/settings/password') }}" method="POST">
	...
	<div class="field">
		<div class="control">
			<label for="Category" class="label">Nouveau mot de passe</label>
			<input
				id="type"
				type="password"
	...
	<div class="field">
		<div class="control">
			<label for="Category" class="label">Confirmer le nouveau mot de passe</label>
			<input
				id="type"
				type="password"
	...
	<div class="field">
		...
		<div class="control">
			<input
				id="first_name"
				type="text"
				class="input is-rounded {{ $errors->has('last_name') ? ' is-invalid' : '' }}"
				name="first_name"
...
<form action="{{ url('admin/settings/contact') }}" method="POST">
    ...
    <br>
									...
									<div class="field">
										<label for="email_contact" class="label"
											>Adresse E-mail de contact (Optionnel)</label
										>
										...
										<div class="control">
											<input
												id="email_contact"
												type="text"
												class="input is-rounded {{ $errors->has('email_contact') ? ' is-invalid' : '' }}"
												name="email_contact"
									...
									<div class="field">
										<label for="phone" class="label"
											>Numéro de contact (Optionnel)</label
										>
										...
										<div class="control">
											<input
												id="phone"
												type="text"
												class="input is-rounded {{ $errors->has('phone') ? ' is-invalid' : '' }}"
												name="phone"
												value="{{ $user->phone }}"
											/>
									...
									<div class="field">
										...
										<div class="control">
											<input
												id="city"
												type="text"
												class="input is-rounded {{ $errors->has('city') ? ' is-invalid' : '' }}"
												name="city"
												value="{{ $user->city }}"
												data-validate="require"
												required
