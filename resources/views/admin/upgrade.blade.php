	...
	<div class="container">
		...
		<div class="columns is-centered has-text-centered">
			<div class="column is-8">
				...
				<br>
				<a class="button is-link is-medium is-rounded" href="{{ url('admin') }}">Retourner au panneau de contrôle</a>
			</div>
		</div>
	</div>
</section>
...
<form
	method="POST"
	action="{{ url('admin/settings/upgrade/summary') }}"
	name="initiation"
>
	@csrf
			...
			<div class="columns is-vcentered is-centered">
				...
				@foreach($programs as $program)
					...
					@component('components.program') 
						...
						<input
							type="radio"
							class="is-checkradio is-primary is-large"
							name="program"
							id="{{ $program->name }}"
							value="{{ $program->name }}"
							onclick="showProgramThemes()"
...
<script type="text/javascript">bulmaSteps.attach();</script>
