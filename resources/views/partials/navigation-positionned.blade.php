    ...
    <div class="container">
        <div class="navbar-brand">
            <a href="{{ route('home') }}" class="navbar-item">
                    <img src="{{ $color == 'is-primary' ? asset('svg/logo-inverted.svg') : asset('svg/logo.svg') }}" width="75px">
            </a>
            ...
            <div class="navbar-end">
                ...
                <div class="navbar-item has-dropdown is-hoverable">
                    ...
                    <div class="navbar-dropdown is-boxed">
                        ...
                        <a class="navbar-item has-text-black" onclick="toggleActiveClass('#logout')"> Se déconnecter </a>
                    </div>
                </div>
                @endauth                
